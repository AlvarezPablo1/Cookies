...
const PremiumProduct = () => {
  return (
    <div className="relative bg-[#000] overflow-x-hidden py-14  lg:flex 2xl:justify-center lg:flex-row md:items-center">
      ...
      <div className=" px-[1rem] min-[1440px]:pl-[4rem] pb-5">
        ...
        <p className="text-[20px  ] md:text-[26px] md:w-[509px]  pb-6">Our best-in-class in-house cultivation, global varieties, and full lineup of strain-specific products. </p>
        <Button text={"BUY NOW"} link={"https://seeds.cookies.co/"} />
      </div>
      <section className="lg:w-[500px] min-[1440px]:w-[720px] 2xl:w-[1500px]">
        <CarouselPremium/>
      </section>
