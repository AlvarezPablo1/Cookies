...
const Adventages = () => {
  return (
    <div className="relative  flex flex-col  lg:flex-row bg-black justify-between overflow-y-hidden">
        <section className="absolute shadow-[0_5px_900px_100px] md:shadow-[0_5px_900px_150px] shadow-[#45A7E1] md:shadow-[#45A7E1] top-[80%] "/>
      ...
      <div className="pt-10 px-1 min-[1440px]:pl-[6rem]">
