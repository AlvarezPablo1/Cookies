...
const Description = () => {
  return (
    <div className="relative flex flex-col-reverse 2xl:items-center">
      ...
      <div>
      <div className="relative lg:w-[722px] flex flex-col items-start min-[1440px]:mt-16 gap-y-2 px-[1rem] md:pl-[4rem] lg:pl-[4rem]">
        <section >
